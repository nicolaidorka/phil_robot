...
const uint8_t TMC4361_homing_sw[4] = {RGHT_SW, RGHT_SW, RGHT_SW, LEFT_SW};
...
void setup() {
  ...
  */
  ...
  tmc4361A_enableLimitSwitch(&tmc4361[z], rht_sw_pol[z], RGHT_SW, true);
  tmc4361A_enableLimitSwitch(&tmc4361[z], lft_sw_pol[z], LEFT_SW, true); // removing this causes z homing to not work properly
        ...
        case INITIALIZE:
          {
            ...
            tmc4361A_enableLimitSwitch(&tmc4361[y], rht_sw_pol[y], RGHT_SW, flip_limit_switch_y);
            tmc4361A_enableLimitSwitch(&tmc4361[z], rht_sw_pol[z], RGHT_SW, true);
            tmc4361A_enableLimitSwitch(&tmc4361[z], lft_sw_pol[z], LEFT_SW, true);
            // motion profile
            uint32_t max_velocity_usteps[N_MOTOR];
            uint32_t max_acceleration_usteps[N_MOTOR];
            max_acceleration_usteps[x] = tmc4361A_ammToMicrosteps(&tmc4361[x], MAX_ACCELERATION_X_mm);
